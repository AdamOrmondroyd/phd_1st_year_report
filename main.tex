...
\end{equation}
%
for events $A$ and $B$. This can be reframed in terms of \textit{``updating the prior''}:
\begin{equation}
  \label{bayes-simple}
...
A Monte Carlo algorithm is a randomised algorithm, whose result will differ from the true result with known probability. The Monte Carlo integration uses the approximation
